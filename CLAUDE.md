...
This project is indexed by GitNexus as **chaincheck** (1385 symbols, 4275 relationships, 114 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/chaincheck/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/chaincheck/context` | Codebase overview, check index freshness |
| `gitnexus://repo/chaincheck/clusters` | All functional areas |
| `gitnexus://repo/chaincheck/processes` | All execution flows |
| `gitnexus://repo/chaincheck/process/{name}` | Step-by-step execution trace |
